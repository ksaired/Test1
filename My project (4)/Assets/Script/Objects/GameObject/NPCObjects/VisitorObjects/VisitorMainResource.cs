...
public class VisitorMainResource : VisitorResource
{
    ...
    private float DeffaultSizeOfFirstDetectedCircle = 2f;
    ...
    public override void ChangeSizeOfFirstDetectedCircle(float NewSizeOfFirstDetectedCircle)
    {
        base.ChangeSizeOfFirstDetectedCircle(NewSizeOfFirstDetectedCircle);
    }
