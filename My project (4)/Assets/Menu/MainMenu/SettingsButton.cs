...
public class SettingsButton : LoadMenuFacade
{
    ...
    public override string ObjectPath { get => DeffaultLoadMenuPath; protected set => DeffaultLoadMenuPath = value; }
    ...
    private string DeffaultLoadMenuPath = "SettingsMenuPath";
