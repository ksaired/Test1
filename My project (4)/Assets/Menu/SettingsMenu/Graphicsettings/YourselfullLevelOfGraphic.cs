...
public class YourselfullLevelOfGraphic : LevelOfOverallGraphic
{
    ...
    public override string LevelOf { get => base.DeffaultTypeLevelOfGraphic[3]; }
    public override string SpriteLoadKindPath { get => LevelOfGraphicSpriteLoadKindPath + LevelOfOverallGraphicLoadKindPath + LevelOfOverallYourselfullGraphicLoadKindPath; protected set => base.SpriteLoadKindPath = value; }

    protected string LevelOfOverallYourselfullGraphicLoadKindPath = UIInfo.GetLinkToAssets("LevelOfOverallYourselfullGraphicSpriteLoadKindPath");
